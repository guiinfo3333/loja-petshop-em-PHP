...
<div class="catalog">
        <div class="container">
            <div id="carousel" class="carousel slide" style="margin-top: 20px; width: 100%;">
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <a href="#"><img src="img/bannerPet.jpg" alt=""></a>
...
$sq1="select p.nome, p.info_aditiva,p.descricao,p.imagem,c.descricao,p.idproduto,p.valor from produto as p join categoriaproduto as c on c.idcategoriaproduto= p.categoriaproduto_idcategoriaproduto where p.categoriaproduto_idcategoriaproduto=2 order by p.idproduto DESC limit 8;";
       ...
       <section class="painel novidades" style="margin-left: -20px; margin-top:0px;">
            ...
            <h2>Marcas Variadas</h2>
             <ol>
                   <?php
include 'testephp/Conexao.php';
$sq1="select p.nome, p.info_aditiva,p.descricao,p.imagem,c.descricao,p.idproduto,p.valor from produto as p join categoriaproduto as c on c.idcategoriaproduto= p.categoriaproduto_idcategoriaproduto where p.categoriaproduto_idcategoriaproduto=2 order by p.idproduto DESC limit 16;";
$fica=mysqli_query($con,$sq1); 
while($vreg= mysqli_fetch_row($fica)){
                echo "
                <li>
