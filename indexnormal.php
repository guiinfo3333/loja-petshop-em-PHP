...
$sq1="select p.nome, p.info_aditiva,p.descricao,p.imagem,c.descricao,p.idproduto,p.valor from produto as p join categoriaproduto as c on c.idcategoriaproduto= p.categoriaproduto_idcategoriaproduto  order by p.idproduto DESC;";
...
?>
        ...
        <section class="painel variados" style="margin-left: -20px; margin-top:-120px;">
            <h2>Acessórios Variados </h2>
            <ol>
                <?php
include 'testephp/Conexao.php';
$sq1="select p.nome, p.info_aditiva,p.descricao,p.imagem,c.descricao,p.idproduto,p.valor from produto as p join categoriaproduto as c on c.idcategoriaproduto= p.categoriaproduto_idcategoriaproduto  order by p.idproduto DESC;";
...
?>
        ...
        <section class="painel racas" style="margin-left: -20px; ">
        <h2>Raças de Cães</h2>
            <ol>
                ...
                <li>
                    <a href="#">
                        <figure>
                            <img src="img/racas_caes/rottweiler.jpg" class="arr">
                            <b><figcaption>Rottweile
                            </figcaption></b>
                        </figure>
                    </a>
                </li> <li>
                ...
                <li>
                    <a href="#">
                        <figure>
                            <img src="img/racas_caes/Golden-retriever.png">
                            <b><figcaption>Golden Retriver
                            </figcaption></b>
                        </figure>
                    </a>
                </li>
                 ...
                 <li>
                    <a href="#">
                        <figure>
                            <img src="img/racas_caes/pinscher.jpg">
                            <b><figcaption>Pinscher
                            </figcaption></b>
                        </figure>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <figure>
                            <img src="img/racas_caes/pit.jpg">
                            <b><figcaption>Pit Bull
                            </figcaption></b>
                        </figure>
                    </a>
                </li>
                 ...
                 <li>
                    <a href="#">
                        <figure>
                            <img src="img/racas_caes/yorkshire.png">
                            <b><figcaption>Yorkshire
                            </figcaption></b>
                        </figure>
                    </a>
                </li>
