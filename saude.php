...
<div class="catalog">
        <div class="container">
            <div id="carousel" class="carousel slide" style="margin-top: 10px; left:20%; width: 70%;">
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <a href="#"><img src="img/saude.jpg" alt=""></a>
...
$sq1="select p.nome, p.info_aditiva,p.descricao,p.imagem,c.descricao,p.idproduto,p.valor from produto as p join categoriaproduto as c on c.idcategoriaproduto= p.categoriaproduto_idcategoriaproduto where p.categoriaproduto_idcategoriaproduto=3 order by p.idproduto DESC limit 8;";
